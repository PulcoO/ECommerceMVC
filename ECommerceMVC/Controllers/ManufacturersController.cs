...
namespace ECommerceMVC.Controllers
{
    public class ManufacturersController : Controller
    {
        ...
        public ManufacturersController(ApplicationDbContext context, IManufacturerRepository manufacturerRepository)
        {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Manufacturer manufacturer, string? redirection)
        {
            if (ModelState.IsValid)
            {
                ...
                if (redirection != null)
                {
                    ...
                    {
                        return RedirectToAction("Create", "Products", new { manufacturerId = manufacturer.Id });
                    }
                }
                return View(manufacturer);
            }
